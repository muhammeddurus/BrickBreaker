function brickBreaker() {
    ...
    var dx = 2; //top Hareket
    var dy = -2; //top Hareket
    ...
    draw = function () {
        ...
        if ((y + dy < ballRadius ||
            ...
            if (y + dx < 20) {
                document.getElementById("naber").addEventListener('click',function (){
                    location.reload();
                });
                showGoMenu();
                ...
                document.getElementById("naber2").addEventListener('click',function (){
                    location.reload();
                });
                showGoMenu1();
